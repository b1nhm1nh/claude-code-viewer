import type { ToolResultContent } from "@ccv/shared/conversation-schema/content/ToolResultContentSchema.ts";
import type { Conversation } from "@ccv/shared/conversation-schema/index.ts";
