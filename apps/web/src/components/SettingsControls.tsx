import { DEFAULT_LOCALE, detectLocaleFromNavigator } from "@ccv/shared/i18n/localeDetection";
import type { SupportedLocale } from "@ccv/shared/i18n/schema";
import { TERMINAL_CHOICES } from "@ccv/shared/terminal-launcher/keys";
...
import { useIsSubscriptionMode } from "@/hooks/useIsSubscriptionMode";
