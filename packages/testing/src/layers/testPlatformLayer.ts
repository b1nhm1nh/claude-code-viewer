import { EventBus } from "@ccv/server/core/events/services/EventBus";
import type { EnvSchema } from "@ccv/server/core/platform/schema";
import {
  ApplicationContext,
  type ClaudeCodePaths,
} from "@ccv/server/core/platform/services/ApplicationContext";
import {
  type CcvOptions,
  CcvOptionsService,
} from "@ccv/server/core/platform/services/CcvOptionsService";
import { EnvService } from "@ccv/server/core/platform/services/EnvService";
import { UserConfigService } from "@ccv/server/core/platform/services/UserConfigService";
import type { UserConfig } from "@ccv/server/lib/config/config";
import { DEFAULT_LOCALE } from "@ccv/shared/i18n/localeDetection";
